...
export default function ReviewForm({
  ...
  /* What to call the other side of the conversation. Resolved from the site that
     sold this client, because "us" to them is their supplier, not this platform. */
  authorLabel: string;
  batchId: string;
  reviewable: boolean;
