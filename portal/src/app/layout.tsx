 ...
 * marketing description a website serves. Individual screens still set their own
 * titles; this is only the fallback.
 *
 * Neutral, and it has to be. This layout wraps every site's portal and cannot ask
 * which one a request belongs to, so any brand name here would be one customer's
 * name printed in every other customer's browser tab.
 */
