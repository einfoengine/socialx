...
export const SETTINGS_NAV: SettingsGroup[] = [
    ...
    items: [
      {
        href: "/admin/settings",
        label: "General",
        help: "Platform-wide configuration. Anything belonging to one website is on that site.",
        writes: true,
      },
      {
  ...
  },
  {
    ...
    items: [
      {
        href: "/admin/settings/ordering",
        label: "Ordering",
        help: "Which ways an order can be created, and what happens to money nobody can verify.",
        writes: true,
      },
      {
        href: "/admin/settings/billing",
        label: "Payments",
        help: "Whether a site may collect its own money, and how old imported billing may get.",
        writes: true,
      },
    ],
  },
  {
    title: "Developer",
    items: [
      /* API keys are not here any more. A credential belongs to one site, so it is
         issued and revoked on that site's record under Sites; a workspace-wide
         list would have to ask which site on every row. */
      {
