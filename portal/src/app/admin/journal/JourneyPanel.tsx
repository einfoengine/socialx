...
const ACTOR_STYLE: Record<JourneyActor, string> = {
  ...
  provider: "bg-[#3D4AFF]/12 text-[#3D4AFF] dark:text-[#7C86FF]",
          ...
          <ol className="border border-black/10 dark:border-white/10 bg-white dark:bg-[#111118]">
            {phase.steps.map((s) => (
              ...
              >
                ...
                <span
                  /* No uppercase here. These chips sit beside names a site chose
                     for itself elsewhere in the console, and text-transform would
                     flatten a casing that is somebody's brand. */
