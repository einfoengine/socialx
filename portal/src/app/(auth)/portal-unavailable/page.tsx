 ...
 *
 * No link out, and no brand but the platform's own. Without a database there is no
 * site registry to consult, so this page genuinely cannot know which website the
 * visitor came from; a link to one particular customer's site would be a guess,
 * and on a platform serving several it would usually be the wrong one.
 */
    ...
    <main className="min-h-screen flex items-center justify-center bg-[#F4F2EF] dark:bg-[#050508] px-6">
      <div className="max-w-[480px]">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed mb-5">
          ...
          into and no site registry to read. Any website integrated with it is
          unaffected.
        </p>
