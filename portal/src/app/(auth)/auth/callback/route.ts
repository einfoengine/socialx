...
export async function GET(request: NextRequest) {
  ...
  /* Validated, not defaulted. This value is concatenated onto the origin below,
     and a `next` that is not a path on this host turns that concatenation into a
     redirect off the site, taken immediately after a successful sign-in. */
