...
export type JourneyActor = "client" | "socialx" | "both";
...
export const JOURNEY: JourneyPhase[] = [
  {
    ...
    steps: [
      ...
      { n: 6, actor: "socialx", text: "Gets notified of the submission" },
      { n: 7, actor: "socialx", text: "Confirms the brief was received and work has started" },
      { n: 8, actor: "socialx", text: "Runs a comprehensive audit" },
      { n: 9, actor: "socialx", text: "Submits the audit report" },
    ],
  },
  {
    title: "Monthly cycle",
    repeats: true,
    steps: [
      { n: 10, actor: "socialx", text: "Builds the content plan" },
      { n: 11, actor: "socialx", text: "Submits the plan" },
      { n: 12, actor: "client", text: "Approves the plan" },
      { n: 13, actor: "socialx", text: "Produces the posts" },
      { n: 14, actor: "socialx", text: "Uploads the designs and captions" },
      { n: 15, actor: "client", text: "Sees the posts in the portal" },
      { n: 16, actor: "client", text: "Approves or leaves comments" },
      { n: 17, actor: "socialx", text: "Applies the corrections" },
      { n: 18, actor: "socialx", text: "Schedules the posts in the HL Social Planner" },
      { n: 19, actor: "socialx", text: "Confirms the schedule to the client" },
      { n: 20, actor: "socialx", text: "Sends the month end report and requests a meeting" },
      { n: 21, actor: "client", text: "Books a meeting date and time" },
      { n: 22, actor: "both", text: "Holds the meeting" },
      { n: 23, actor: "socialx", text: "Builds the plan for the next month" },
    ],
  },
];
