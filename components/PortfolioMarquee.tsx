...
export default function PortfolioMarquee() {
  return (
    <section className="bg-black py-0 relative overflow-hidden w-full border-b border-white/5" id="gw-portfolio">
      <div className="w-full flex flex-col md:flex-row items-stretch bg-black overflow-hidden">
        ...
        <div className="relative flex-1 overflow-hidden flex items-center bg-black">
          <div className="flex gap-0 animate-marquee py-0 whitespace-nowrap hover:[animation-play-state:paused] cursor-grab active:cursor-grabbing">
