 ...
 * which remote host is allowed. Without this, every preview in both portals fails
 * with an unconfigured-host error rather than a broken image, which is easy to
 * misdiagnose.
 *
